...
// Add a reverse reference to the DOM object
        ...
        var questions = base.options.questions,
            ...
            score = 0,
            answerLocked = false,
            user_id =  base.options.user_id,
            quiz_id = base.options.quiz_id;
        var a = new Date();
...
// if results screen not in DOM, add it
            ...
            answerQuestion: function (answerEl) {
                ...
                if (typeof base.options.answerCallback === 'function') {
                    base.options.answerCallback(currentQuestion,
                        selected === correct);
                }
            },
...
// if gameover screen not in DOM, add it
            ...
            finish: function () {
                ...
                if (typeof base.options.finishCallback === 'function') {
                    base.options.finishCallback(score);
                }
                var dataSend = {"score":score, "user_id":user_id, "quiz_id":quiz_id};

                jQuery.ajax({
                    url: 'http://quiz.test/ajax',
                    type: "POST",
                    data: dataSend,
                    success: function () {
